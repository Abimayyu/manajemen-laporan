                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            @if (auth()->user()->role === 'admin')
                                <a href="{{ route('laporanweb.create') }}" class="btn btn-primary float-right">Tambah
                                    Laporan</a>
                            @endif
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    @foreach($laporan as $l)
                                        <tr>
                                            ...
                                            <td>{{ $l->tanggal_laporan ? \Carbon\Carbon::parse($l->tanggal_laporan)->isoFormat('D MMMM Y') : '-' }}</td>
                                            <td>
                                                <div class="btn-group">
                                                    <a href="{{ route('laporanweb.edit', $l->id) }}" class="btn btn-success">
                                                        <i class="fas fa-edit" title="Edit Laporan"></i>
                                                    </a>
                                                    @if(auth()->user()->role === 'admin')
                                                        <form action="{{ route('laporanweb.destroy', $l->id) }}" method="POST" style="display:inline;">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit" class="btn btn-danger" title="Hapus Laporan">
